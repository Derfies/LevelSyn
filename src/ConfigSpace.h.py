...
public:
    ...
    float GetConfigLineLength()

    float GetConfigLineSqLength()
...
public:
    ...
    CConfigSpace( CRoom& room1, room2)
    ...
    static CConfigSpace FindIntersection(CConfigSpace& configSpace1, configSpace2)

    static CConfigSpace FindUnion(CConfigSpace& configSpace, configLine)
    ...
    static bool CompareConfigLineLength( CConfigLine& line1, line2)

    static void PrecomputeTable( std.vector<CRoom>& vecRooms)
