...
public:
	...
	CRoomEdge(v2f pos1, pos2) : CLineBase(pos1, pos2)
		m_idx1 = -1
		m_idx2 = -1
		m_doorFlag = True


	CRoomEdge(v2f pos1, pos2, idx1, idx2) : CLineBase(pos1, pos2), m_idx1(idx1), m_idx2(idx2)
		m_doorFlag = True
	...
	int GetIdx1()  { return m_idx1;
	int GetIdx2()  { return m_idx2;
