...
public:
    ...
    CLineBase(v2f pos1, pos2) :
        m_pos1(pos1), m_pos2(pos2)


    float GetLength()  { return mag(m_pos2 - m_pos1);

    float GetSqLength()  { return mag2(m_pos2 - m_pos1);

    v2f GetPos1()  { return m_pos1;
    v2f GetPos2()  { return m_pos2;
